...
| :file_folder: `dashboard/`          | Web dashboard files.         |
...
| :file_folder: `system/`             | **Significantly** important class definitions of ResilientDB are found here such as `WorkerThread` and `ClientThread`.         |
