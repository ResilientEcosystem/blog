...
4. After you successfully started the kv-service of the ResilientDb, please modify the path in [chain_operation.py](chain_operation.py) to make sure that the first path is point to your ResilientDb folder and second path is poit to /scripts/deploy/config_out/client.config file.
